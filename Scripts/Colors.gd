...
const menu_background = Color.lightskyblue
const menu_background_secondary = Color(0.3956, 0.6665, 0.86)

const menu_line_edit_background = Color(0, 0.256, 0.48, 0.6)
const menu_line_edit_font = Color.white
